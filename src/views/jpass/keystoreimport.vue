        ...
        <div style="width:35%;box-shadow: 0 0 7px 1px #c5c5c5;border:1px solid white;margin:0 auto;border-radius:10px;">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm"
                ...
                <el-form-item label="旧登录密码" prop="password">
                    <el-input type="password" v-model="ruleForm.password" placeholder="请输入旧的登录密码" oncopy="return false"
                ...
                <el-form-item label="新用户名称" prop="name">
                    <el-input type="text" v-model="ruleForm.name" placeholder="新用户名将代替旧用户名" oncopy="return false"
                              onpaste="return false" style="width:90%;"></el-input>
                    <span>&nbsp;&nbsp;&nbsp;</span>
                </el-form-item>
                <el-form-item label="新登录密码" prop="newPassword">
                    <el-input type="password" v-model="ruleForm.newPassword " @input="pwdLength" placeholder="新密码将代替旧密码"
                              oncopy="return false"
                ...
                <el-form-item label="" prop="">
                    <el-button type="primary" style="width:40%;float:left" @click="submitForm('ruleForm')">导入钱包</el-button>
