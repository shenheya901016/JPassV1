<template>
  <body class="sy" @mousemove="GetXYPosition">
    ...
    <header class="header">
      <!-- 全局隐藏域 -->
      <img
        :src="`${publicPath}img/misc/lock.svg`"
        ref="icon_default"
        style="display: none"
      />
      ...
      <div class="hr" style="width: 40%;">
        ...
        <el-button
          style="border:0;height: 50px;margin: auto 0;"
          @click="logOut"
        >
          <img
            style="top:-2px;height: 25px;width: 25px;"
    ...
    <aside class="aside">
      ...
      <nav class="nav" style="">
        ...
        <ul
          class="wjj"
          style="display: flex;flex-direction: column;padding: 0 1.8vw 0 2.5vw;"
        >
          <li
            style="height: 35px;line-height: 35px;border-radius: 7px;margin-bottom: 2%"
          ...
          >
            <img
              style="height: 35px;width: 20px;float: left;text-align: left;margin-left: 2px"
              :src="`${publicPath}img/directory/${project.imgPath}`"
              alt=""
            />
            <span
              :title="project.name"
              style="float: left;text-align: left;margin-left:3%;"
            >
              {{
            ...
            >
            <i
              style="float: right;color: #A8B1C6;width: 47px;height: 23px;text-align: center;border-radius: 11.5px;line-height: 23px; margin-top: 7px;position: absolute;right: 2vw;"
              >{{ project.count }}</i
            >
          </li>
        </ul>
      ...
      <ul id="menu_1" class="menu">
        ...
        <li
          v-if="delobj.modelsType == 'directory'"
          :class="toTop"
          @click="toTop"
        >
          <img
        ...
        >
          ...
          <template v-for="(data, index) in this.projectEvent.datas">
            ...
            >
              ...
              ></a>
              <div
                style="width:50%;display: inline-block;line-height: 10px; vertical-align: middle;"
              >
                <el-progress
                  id="process"
                  :stroke-width="15"
            ...
            <el-form-item
              v-else-if="
                data.type === 'password' && showPassword && data.val != ''
              "
              :label="data.tempkey"
              :prop="data.tempkey"
              style="margin-bottom:3px;"
            ...
            <el-form-item
              ...
              style="margin-bottom:3px;"
            >
              <input type="text" v-model="data.val" readonly /><a
                :href="
                  data.val.indexOf('https://') == -1 &&
                  data.val.indexOf('http://') == -1
                    ? 'https://' + data.val
                    : data.val
                "
                target="_blank"
          ...
          <template v-for="(data, index) in this.projectEvent.note">
            ...
            >
              <div
                id="textarea"
                ref="textarea"
                v-html="data.notes.replace(/\n|\r\n/g, '<br />')"
                style="border:0;white-space: pre-wrap;"
                readonly
              ></div>
      ...
      >
        ...
        >
          <el-form-item :label="$t('main.name')" prop="pName" style="">
            <el-input
              v-model.trim="ruleFormRename.pName"
              style="width:100%;"
            ></el-input>
          </el-form-item>
          <el-form-item
                ...
                <template v-for="(data, index) in this.templateEvent.datas">
                  ...
                  >
                    ...
                    <a href="#" @click="changePass($event)"
                      ><i class="el-icon-view"></i
                    ></a>
                    <a href="#" @click="passwordGenerator(data)"
                      ><i class="el-icon-key"></i
                    ></a>
                    <a href="#" @click="addProjectRemoveItem(data.id)"
              ...
              >
                <template v-for="(data, index) in this.tempTemplate">
                  ...
                  >
                    ...
                    ></a>
                    <a href="#"
                      ><i class="el-icon-close" @click="addOtherItems(data.id)">
                      </i
                    ></a>
              ...
              >
                <template v-for="(data, index) in this.editobject.datas">
                  ...
                  >
                    <el-date-picker
                      v-model="data.val"
                      class="input-class-template-edit"
                      value-format="yyyy-MM-dd"
                      type="date"
                      placeholder="选择日期"
                      size="large"
        ...
        <el-form>
          <el-tabs v-model="activeName" type="border-card" style="height:55vh">
            <el-tab-pane :label="$t('main.generic')" name="generic">
              <el-form-item prop="">
                <fieldset
                  style="width: 80%;height:14vh;margin: auto;border: 1px solid #6C6C6C"
                >
                  ...
                  <div style="margin-left: 2vw">
                    ...
                    <el-switch
                      v-model="autoStartFlag"
                      active-color="#13ce66"
                      inactive-color="#ff4949"
                      @change="changeAutoStartFlag"
                    ></el-switch>
                  </div>
                </fieldset>
              </el-form-item>
              ...
              <el-form-item prop="">
                <fieldset
                  style="width: 80%;margin: auto;height: 12vh;border: 1px solid #6C6C6C"
                >
                  <legend style="margin-left: 1%">
                    {{ $t("main.language") }}
                  </legend>
            ...
            <el-tab-pane :label="$t('main.security')">
              <el-form-item prop="">
                <fieldset
                  style="width: 80%;height: 10vh;margin: auto;border: 1px solid #6C6C6C"
                >
                  <legend style="margin-left: 1%">
              ...
              <el-form-item prop="">
                <fieldset
                  style="width: 80%;margin: auto;border: 1px solid #6C6C6C"
                >
                  <legend style="margin-left: 1%">
                    {{ $t("main.locking") }}
                  </legend>
                  <span
                    style="display:inline-block;width: 60vh;margin-left: 2vw"
                  >
                    {{ $t("main.timedLock") }}
                    <el-switch
                      v-model="systemlock"
        ...
        <el-tabs type="border-card" style="text-align: left">
          ...
          <el-tab-pane label="finances">
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/amex.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/atm.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/bank.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/bitcoin.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/coins.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/finances/credit_card.svg`
                )
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/finances/diners_club.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/dollar.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/euro.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/jcb.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/finances/mastercard.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/meastro.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/money.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/paypal.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/finances/piggy_bank.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/pound.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/ruble.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/rupee.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/visa.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/yen.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/finances/rupay.svg`)
              "
            />
          </el-tab-pane>
          <el-tab-pane label="internet">
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/amazon.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/at_sign.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/blog.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/internet/community.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/download.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/ebay.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/email.svg`)
              "
            />
            <img
            ...
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/in.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/internet/instagram.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/joomla.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/mail_ru.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/internet/pinterest.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/rss.svg`)
              "
            />
            <img
            ...
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/vk.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/web_site.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/internet/worldpress.svg`
                )
              "
            />
            <img
            ...
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/internet/ya.svg`)
              "
            />
          </el-tab-pane>
          <el-tab-pane label="misc">
            ...
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/misc/default.svg`)
              "
            />
            <img
            ...
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/misc/network.svg`)
              "
            />
            <img
            ...
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/misc/picture.svg`)
              "
            />
            <img
            ...
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/misc/shopping_cart.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/misc/suitcase.svg`)
              "
            />
          </el-tab-pane>
          <el-tab-pane label="personal">
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/personal/dental_insurance.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/eye.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/fitness.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/food.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/glasses.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/personal/health_insurance.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/hospital.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/house.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/id.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/personal/insurance.svg`
                )
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/personal/membership.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/passport.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/pets.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/personal/prescription.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/shield.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/personal/social_security.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/tshirt.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/user.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/personal/user2.svg`)
              "
            />
          </el-tab-pane>
          <el-tab-pane label="technology">
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/adobe.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/android.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/apple.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/calling_card.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/camera.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/cd.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/computer.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/gaming.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/hard_drive.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/laptop.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/phone.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/printer.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/router.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/sd_card.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/server.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/sim_card.svg`
                )
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/smartphone.svg`
                )
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/source_code.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/tablet.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/tv.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/ubuntu.png.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/video.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/voicemail.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/technology/wifi.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/technology/windows.svg`
                )
              "
            />
          </el-tab-pane>
          <el-tab-pane label="transport">
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/transport/airplane.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/bicycle.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/bus.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/car.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/garage.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/gas.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/transport/helicopter.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/jeep.svg`)
              "
            />
            <img
              ...
              @click="
                setImageBase64(
                  $event,
                  `${publicPath}img/transport/motorcycle.svg`
                )
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/parking.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/scooter.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/ship.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/train.svg`)
              "
            />
            <img
              ...
              class="temlateSymbol"
              @click="
                setImageBase64($event, `${publicPath}img/transport/truck.svg`)
              "
            />
          </el-tab-pane>
        </el-tabs>
      ...
      >
        ...
        <div style="margin-top:1vh;text-align: center">
          <span style="float: left;line-height: 5vh;margin-right: 1vw;"
            >选择分类</span
          >
          <el-select
            v-model="selectlabels"
              ...
              >
                <el-form-item>
                  <el-input
                    type="textarea"
                    :rows="16"
                    v-model="ruleFormNoteEdit.notes"
                  ></el-input>
                </el-form-item>
              </el-form>
            </div>
      ...
      <el-dialog
        :title="$t('main.import')"
        :visible.sync="importFileDialog"
        width="30%"
        @close="importClose"
      >
        <span>
          <el-select
            v-model="import_file_type"
            :placeholder="$t('main.pleaseChoose')"
          >
            <el-option
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          <el-button size="small" @click="updateDialog = false"
            >取 消</el-button
          >
