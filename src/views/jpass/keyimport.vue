  ...
  <div style="width:100%;" id="main">
    ...
    >
      ...
      >
        ...
        <!--</el-form-item>-->
        <el-form-item
          :label="$t('keyImport.passwordRepetition')"
          prop="repassword"
        >
          <el-input
            type="password"
        ...
        <el-dialog
          :title="$t('keyImport.walletImportedSuccessfully')"
          :visible.sync="dialogVisible"
          width="40%"
        >
          <el-button type="primary" size="small" @click="exportkeystore"
            >{{ $t("keyImport.keystoreExport") }}
          </el-button>
        ...
        return {
            ...
            rules: {
                ...
                password: [
                    ...
                    {min: 6, message: this.$t('keyImport.lengthIsBetween4And20Characters'), trigger: 'blur'}
                ],
                repassword: [
                    {
                        required: true,
