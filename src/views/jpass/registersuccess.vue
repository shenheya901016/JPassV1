<template>
  <div style="width:100%;" id="main">
    ...
    <div
      style="width:60%;border:1px solid white;margin:2% auto;border-radius:10px;box-shadow: 0 0 7px 1px #c5c5c5;"
    >
      <div
        style="width:100%;border-radius:10px 10px 0 0; font-size:18px;margin-top:50px; color: #66B1FF;text-align: left"
      >
      ...
      >
        ...
        <el-form-item
          :label="$t('registersuccess.keystoreFile')"
          prop="password"
        >
          <el-button
            type="primary"
            ...
            style="float: left;"
            >{{ $t("registersuccess.exportKeystoreFile") }}</el-button
          >
        </el-form-item>
        <el-form-item label="">
          <el-button
            ...
            @click="toMainPage"
            >{{ $t("registersuccess.login") }}</el-button
          >
        </el-form-item>
      </el-form>
