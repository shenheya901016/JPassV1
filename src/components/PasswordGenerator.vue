<template>
  <!--密码生成器-->
  <el-dialog :title="$t('main.passwordGenerator')" :visible.sync="dialogVisiblePasswordGenerator" width="50%" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="true" @closed="clearPass">
