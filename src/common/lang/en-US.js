...
export default {
  login: {
    ...
    name: "Username",
    nametitle:
      "Please select login user. If there is no data in the drop-down box, please register user first or import the existing wallet!",
    password: "Password",
    login: "Login",
    register: "Register",
  ...
  register: {
    ...
    lengthCharacters: "Length greater than 6 characters！",
  ...
  registersuccess: {
    title:
      '&#12288;Congratulations! your wallet has been registered successfully.Please use your<span style="color: red"> wallet Address</span> to jingtong website to activate your wallet!<p style="color: red;font-size: 15px">Attention:Please copy and keep the following information in time. It is necessary to retrieve your wallet.</p>',
    mnemonic: "Mnemonic:",
  ...
  mnemonicimport: {
    ...
    importSuccessfully:
      "Wallet imported successfully，The Keystore File has been updated,Please download and keep it properly！",
    ...
    lengthBetween4and20Characters: "The length is between 6 and 20 characters!",
    pleaseEnterUserPasswordAgain: "Please enter the user password again!",
  ...
  lock: {
    ...
    unlock: "Unlock",
    thePasswordIsIncorrectPleaseReEnter:
  ...
  keystoreImport: {
    ...
    newUserName: "New Name",
    newUsernameWillReplaceTheOldUsername:
      "The new username replaces the old username!",
    newLoginPassword: "New Password",
    newPasswordWillReplaceTheOldPassword:
      "The new password will replace the old one!",
    passwordRepetition: "RePassword",
    importWallet: "Wallet Import",
    walletImportedSuccessfully:
      "The wallet has been successfully imported and the keystore file has been updated. Please download it in time and keep it safe!",
    keystoreExport: "Keystore Export",
    userNameIsDuplicatePleaseEnter:
      "The user name is duplicate, please enter it again!",
    ...
    theCurrentLimitSelects1FileThisTimeSelectedFiles:
      "Currently restricted uploading 1 file",
    importedKeystoryFilePFailed:
      "Keystory File not imported or file parsing failed, please enter again!",
    theKeystoryFileOrPasswordIsIncorrectPleaseEnter:
      "Keystory Wrong file or password, please enter again!",
  ...
  keyImport: {
    ...
    theLengthIsBetween3And20Characters:
      "The length is between 6 and 20 characters!",
    pleaseEnterAUserPassword: "Please enter the user password!",
    lengthIsBetween4And20Characters:
      "The length is between 6 and 20 characters!",
    pleaseEnterTheUserPasswordAgain: "Please enter the user password again!",
  ...
  main: {
    special: "Special",
    lockRadio: "Ctrl +[Alt]+L to lock JPass",
    KeyboardShortcuts: "Keyboard shortcuts",
    loginOpenJpass:
      "When you logging in to windows, jpass is automatically started",
    mainWindow: "Main",
    ...
    auto_update_prompt: "Automatically update when the app is locked",
    ...
    loginPassword: "Login Password",
    unlock: "Unlock",
    addDirectory: "Add label",
    ok: "Confirm",
    cancel: "Cancel",
    prompt: "Prompt",
    doYouWantToDeleteTheLabel: "Do you want to delete Labels?",
    okFormat: "Confirm",
    cancelFormat: "Cancel",
    doYouWantToDeleteTheProject: "Do you want to delete Card?",
    doYouWantToDeleteTheProjectrestore:
      "After the data is deleted, it cannot be recovered. Are you sure you want to delete the data?",
    ...
    newUserAndPasswordAreAutomaticallySaved:
      "New user and password saved automatically",
    ...
    unlockedSuccessfully: "Unlocked！",
    theInputIsIncorrectPleaseConfirmItAndSubmitItAgain:
      "Input error, please confirm correct before submitting!",
    allProjects: " All cards",
    favorites: "Favorite",
    password: "Password",
    template: "Template",
    unmarked: "Unmarked",
    ...
    trash: "Trash",
    note: "Attention",
    pleaseGoToTheOfficialWebsiteToActivateYourWallet:
      "Please go to the official website to activate your wallet first！",
    weak: "Weakness",
    mid: "Medium",
    strong: "Strong",
    ...
    re_login:
      "Re-login to implement all configuration updates, do you re-login?",
    suggest: "Suggest",
    login: "re_login",
    ...
    symbol: "Symbol",
    synchronizationInfo:
      "The system has detected that your last synchronization operation was not performed in this machine. In order to ensure data integrity, please ensure that the data of the last operation has been successfully synchronized. Please carefully choose the synchronization method!",
    ...
    withoutSynchronization:
      "Local data is the same as IPFS data, no synchronization required!",
    //密码生成器
    passwordGenerator: "Password Generator",
